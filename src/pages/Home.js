			...
			<div className='container row introduction'>
				...
				<div className='bio'>
					...
					<p>
						...
						work on impactful, AI-integrated products that bring value to users at
						scale. Equipped with a diverse skill set, from software development, data
						analysis to deep learning model design, I’m excited to take on new
						challenges.
					</p>
					<p>
						I'm working on creating my own J.A.R.V.I.S :) During my free time, I like to
						build pet projects where I put my skills or my recently acquired knowledge
						to practice. While we're on this, have a look at{' '}
						{createHyperlink('https://amazing.rodonguyen.dev/', 'my pet projects')}.
					</p>

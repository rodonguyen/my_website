		...
		<>
			...
			<div className='container row introduction'>
				...
				<div className='bio'>
					...
					<p>
						...
						work on impactful, interesting, data-driven, AI-integrated products that
						bring value to users at scale. Equipped with a diverse skill set, from
						software development, data analysis to deep learning model design, I’m
						excited to take on new challenges.
					</p>
					<p>
						On the personal side I'm working on creating a J.A.R.V.I.S for me one day :)
						During my free time, I like to build pet projects where I put my skills or
						my recently acquired knowledge to practice. While we're on this, read about
						pet projects below or in Resume tab.
					</p>
			...
			<div className='container skills'>
				...
				<ul>
					...
					<li>
						<b>Others</b>:&ensp; Linux/Ubuntu, Git/GitHub, Embedded Systems, Docker,
			...
			<div className='background-color-2'>
				<div className='container'>
					...
					<ul>
						...
						<li>
							<b>Profile</b>:{' '}
							{createHyperlink('https://www.chess.com/member/rodobolo', 'rodobolo')}
						</li>
					</ul>
				</div>
			</div>
			...
			<div className='container'>
				<p>p.s. </p>
				<p>
					This website is made with bare HTML/CSS, ReactJS and no special styling
					frameworks :){' '}
				</p>

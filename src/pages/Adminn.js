...
const handleRequestDynamoDB = (
	...
	queryDynamoDB(docClient, username, code).then((data) => {
		if (data.Item !== undefined) {
			setResultMessage(
				`[ DUPLICATE ] This item (${username}, ${code}) exists in the database. Nothing else to do. Please enter a different code/username.`
			)
			return
		}
...
const Adminn = () => {
	...
	return (
		<div className="container">
			<CoolerDateForm
				onSubmitFunction={handleRequestDynamoDB}
